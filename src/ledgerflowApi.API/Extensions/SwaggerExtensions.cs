...
public static class SwaggerExtensions
{
    public static IServiceCollection AddSwaggerConfiguration(this IServiceCollection services)
    {
        services.AddSwaggerGen(options =>
        {
            ...
            {
                Title = "ledgerflowApi Financial SaaS API",
                Version = "v1",
                Description = "Multi-tenant financial platform — invoicing and payment management.",
                Contact = new OpenApiContact { Name = "API Support", Email = "support@ledgerflowApi.example" }
            });
    ...
    public static IApplicationBuilder UseSwaggerConfiguration(this IApplicationBuilder app)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "ledgerflowApi API v1");
