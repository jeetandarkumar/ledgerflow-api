...
namespace ledgerflowApi.Infrastructure.Migrations
{
    ...
    [Migration("20260810120000_AddPaymentRefundConcurrencyControl")]
    partial class AddPaymentRefundConcurrencyControl
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ledgerflowApi.Domain.Entities.Payment", b =>
                {
                    ...
                    b.OwnsOne("ledgerflowApi.Domain.ValueObjects.Money", "RefundedAmount", b1 =>
                        {
                            b1.Property<Guid>("PaymentId")
                                .HasColumnType("uniqueidentifier");
