...
using ledgerflowApi.Infrastructure.Caching;
using ledgerflowApi.Infrastructure.Identity;
using ledgerflowApi.Infrastructure.Persistence;
using ledgerflowApi.Infrastructure.Persistence.Repositories;
using ledgerflowApi.Infrastructure.Services;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;

namespace ledgerflowApi.Infrastructure.DependencyInjection;
        ...
        IConfiguration configuration)
    {
        ...
        if (!string.IsNullOrWhiteSpace(redisConnection))
        {
            services.AddStackExchangeRedisCache(options =>
            {
                ...
                options.InstanceName = configuration["Redis:InstanceName"] ?? "ledgerflowApi:";
            });
        }
        else
        {
