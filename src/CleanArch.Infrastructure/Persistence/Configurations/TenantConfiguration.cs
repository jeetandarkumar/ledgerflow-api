...
public class TenantConfiguration : IEntityTypeConfiguration<Tenant>
{
    public void Configure(EntityTypeBuilder<Tenant> builder)
    {
        ...
        // Ignore domain infrastructure — not stored in DB
        builder.Ignore(t => t.DomainEvents);

        // Ignore collection navigations — Users and Invoices are queried
        // through their own repositories, never through Tenant.Users/Invoices.
        // Mapping them here would create circular FK issues and force eager loading.
        builder.Ignore(t => t.Users);
        builder.Ignore(t => t.Invoices);
        ...
        builder.Property(t => t.BillingEmail).IsRequired().HasMaxLength(256);
        ...
        builder.OwnsOne(t => t.BillingAddress, addr =>
        {
